...
app.get('/posts', (req, res) => {
  const sql = "SELECT sex, COUNT(*) as count, AVG(age) as avg_age, AVG(bmi) as avg_bmi, AVG(bmr) as avg_bmr, AVG(tdee) as avg_tdee FROM web WHERE sex IN ('female', 'male') GROUP BY sex";
